    ...
    return (
        ...
        <Container>
            ...
            <div className="Item_button" onClick={this.mobile1.bind(this)}>
                <img className="Product_size" src={require('../Image/Mobiles/Samsung/Samsung1.jpg')} />
                </div>
                <Modal isOpen={this.state.mobile1Open}>
            <ModalHeader toggle={this.mobile1.bind(this)}>Mobile phone</ModalHeader>
            <ModalBody>
            <img className="Products" src={require('../Image/Mobiles/Samsung/Samsung1.jpg')} />
            </ModalBody>
            <ModalFooter>
            ...
            <Col>
                ...
                <img className="Product_size" src={require('../Image/Mobiles/Samsung/Samsung2.jpg')} />
                </div>
            <Modal isOpen={this.state.mobile2Open}>
            <ModalHeader toggle={this.mobile2.bind(this)}>Mobile phone</ModalHeader>
            <ModalBody>
            <img className="Products" src={require('../Image/Mobiles/Samsung/Samsung2.jpg')} />
            </ModalBody>
            <ModalFooter>
                <Button color="primary">Add to Cart</Button>
            ...
            <div onClick={this.mobile3.bind(this)}>
                <img className="Product_size" src={require('../Image/Mobiles/Samsung/Samsung3.jpg')} />
                </div>
            <Modal isOpen={this.state.mobile3Open}>
            <ModalHeader toggle={this.mobile3.bind(this)}>Mobile phone</ModalHeader>
            <ModalBody>
            <img className="Products" src={require('../Image/Mobiles/Samsung/Samsung3.jpg')} />
            </ModalBody>
            <ModalFooter>
                <Button color="primary">Add to Cart</Button>
            ...
            <div onClick={this.mobile4.bind(this)}>
                <img className="Product_size" src={require('../Image/Mobiles/Samsung/Samsung4.jpg')} />
                </div>
            <Modal isOpen={this.state.mobile4Open}>
            <ModalHeader toggle={this.mobile4.bind(this)}>Mobile phone</ModalHeader>
            <ModalBody>
            <img className="Products" src={require('../Image/Mobiles/Samsung/Samsung4.jpg')} />
            </ModalBody>
            <ModalFooter>
                <Button color="primary">Add to Cart</Button>
            ...
            <div onClick={this.mobile5.bind(this)}>
                <img className="Product_size" src={require('../Image/Mobiles/Samsung/Samsung5.jpg')} />
                </div>
            <Modal isOpen={this.state.mobile5Open}>
            <ModalHeader toggle={this.mobile5.bind(this)}>Mobile phone</ModalHeader>
            <ModalBody>
            <img className="Products" src={require('../Image/Mobiles/Samsung/Samsung5.jpg')} />
            </ModalBody>
            <ModalFooter>
                <Button color="primary">Add to Cart</Button>
