					...
					<Row className="container_row">
						<Col className="container_col">
							<div className="Item_button" onClick={this.mobile1.bind(this)}>
								<img className="Product_size" src={require('../Image/Mobiles/Oppo/Oppo1.jpg')} />
							</div>
							<Modal isOpen={this.state.mobile1Open}>
								<ModalHeader toggle={this.mobile1.bind(this)}>Mobile phone</ModalHeader>
								<ModalBody>
									<img className="Products" src={require('../Image/Mobiles/Oppo/Oppo1.jpg')} />
								</ModalBody>
								<ModalFooter>
						...
						<Col>
							...
							<div onClick={this.mobile2.bind(this)}>
								<img className="Product_size" src={require('../Image/Mobiles/Oppo/Oppo2.jpg')} />
							</div>
							<Modal isOpen={this.state.mobile2Open}>
								<ModalHeader toggle={this.mobile2.bind(this)}>Mobile phone</ModalHeader>
								<ModalBody>
									<img className="Products" src={require('../Image/Mobiles/Oppo/Oppo2.jpg')} />
								</ModalBody>
								<ModalFooter>
									<Button color="primary">Add to Cart</Button>
						...
						<Col>
							<div onClick={this.mobile3.bind(this)}>
								<img className="Product_size" src={require('../Image/Mobiles/Oppo/Oppo3.jpg')} />
							</div>
							<Modal isOpen={this.state.mobile3Open}>
								<ModalHeader toggle={this.mobile3.bind(this)}>Mobile phone</ModalHeader>
								<ModalBody>
									<img className="Products" src={require('../Image/Mobiles/Oppo/Oppo3.jpg')} />
								</ModalBody>
								<ModalFooter>
									<Button color="primary">Add to Cart</Button>
					...
					<Row className="container_row">
						<Col>
							<div onClick={this.mobile4.bind(this)}>
								<img className="Product_size" src={require('../Image/Mobiles/Oppo/Oppo4.jpg')} />
							</div>
							<Modal isOpen={this.state.mobile4Open}>
								<ModalHeader toggle={this.mobile4.bind(this)}>Mobile phone</ModalHeader>
								<ModalBody>
									<img className="Products" src={require('../Image/Mobiles/Oppo/Oppo4.jpg')} />
								</ModalBody>
								<ModalFooter>
									<Button color="primary">Add to Cart</Button>
						...
						<Col>
							<div onClick={this.mobile5.bind(this)}>
								<img className="Product_size" src={require('../Image/Mobiles/Oppo/Oppo5.jpg')} />
							</div>
							<Modal isOpen={this.state.mobile5Open}>
								<ModalHeader toggle={this.mobile5.bind(this)}>Mobile phone</ModalHeader>
								<ModalBody>
									<img className="Products" src={require('../Image/Mobiles/Oppo/Oppo5.jpg')} />
								</ModalBody>
								<ModalFooter>
									<Button color="primary">Add to Cart</Button>
